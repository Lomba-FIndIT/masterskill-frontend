            ...
            <v-container>
                ...
                <v-row no-gutters class="mb-6">
                    ...
                    <v-row no-gutters class="mb-6 align-center">
                        ...
                        <v-btn variant="outlined" rounded="xl" border="true" color="#50478A" class="view-all-btn" @click="$router.push('/login')">
                            <span>See All</span>
                                    ...
                                    <v-col cols="12" md="7">
                                        ...
                                        <div class="d-flex">
                                            <v-btn color="#50478A" size="large" class="mr-4" rounded="pill"
                                                elevation="3" prepend-icon="mdi-magnify" @click="$router.push('/login')">
                                                Lihat Lowongan
                                            </v-btn>
